...
final List<Employee> employees = [
  ...
  Employee(id: '1', name: 'Шонин Денис', position: 'Начальник 2', imagePath: 'assets/img/1.png', isBusy: true, status: EmployeeStatus.busy, busyUntil: '14:00', location: 'Коворкинг'),
